...
$sth = $pdo->prepare('SELECT provider_user.name, provider_user.active, provider_rate.name as rate_name, provider_user.debpt, provider_user.usage_time  FROM provider_user JOIN provider_rate on provider_user.rate_id = provider_rate.id where provider_user.debpt>0
');
