...
<body>
                ...
                <div class="row">
                            ...
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Категории<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        ...
                                        <li><a href="<?= yii\helpers\Url::to(['category/create']) ?>">Добавить категории</a></li>
                                    </ul>
                                </li>
                    ...
                    <div class="col-sm-3">
                        <div class="search_box pull-right">
                            <form action="<?= yii\helpers\Url::to(['category/search']) ?>" method="get"><input type="text" name="q" placeholder="Search" /></form>
    ...
    //пришлось установить старый бутстрап, потому что проект ломался
    yii\bootstrap\Modal::begin([
		...
		<button class="btn btn-danger" onclick="clearCart()">Очистить карзину</button>'
    ]);
