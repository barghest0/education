...
$sth = $pdo->prepare('SELECT * FROM provider_rate where speed > 0 AND volume_limit = 0');
$sth->execute();
$rates = $sth->fetchAll();
?>
...
<body>
    <a href="rates.php">Вернуться назад</a>
    <h1>Лучшие тарифы(>30мбит/с, без ограничения)</h1>
